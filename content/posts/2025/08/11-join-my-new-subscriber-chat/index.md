...
[Join chat](https://open.substack.com/pub/digitalsovereignty/chat)

---

## How to get started

1. **Get the Substack app by clicking [this link](https://substack.com/app/app-store-redirect) or the button below.** New chat threads won’t be sent via email. You can turn on push notifications to track conversations as they happen. You can also access chat [on the web](https://open.substack.com/pub/digitalsovereignty/chat).
