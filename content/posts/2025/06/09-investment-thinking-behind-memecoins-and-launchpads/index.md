---
title: "Investment Thinking Behind Memecoins and Launchpads"
...
* [Pima](https://x.com/LeePima) is a legendary crypto OG who invested in many leading L1 blockchains.
...
* Pima didn't have any bag on the **[Base](https://x.com/base)** [chain](https://x.com/base), and therefore missed the opportunity to invest in **Virtuals**.

### Memecoin

* Usually the memecoin ecosystem is valued at about 1-5% of its underlying [L1 blockchai](https://digitalsovereignty.herbertyang.xyz/p/decoding-the-crypto-ecosystem-ep01-blockchains)n's market cap.
...
* Three major launchpads in the current memecoin craze:
  ...
  * [pump.fun](https://x.com/pumpdotfun)
  * [Virtuals](https://x.com/virtuals_io) for AI agents
  * [Believe](https://x.com/believeapp) for attentionFi and independent developers from Web2
* Believe
...
* pump.fun
  ...
  * [pump.fun has $1 billion revenue in 2024](https://www.chaincatcher.com/en/article/2165425)
...
* Gas fee consists of base fee and acceleration fee:
  ...
  * MEV, REV (“**Realized Extractable Value**”) and [Priority Fee](https://solana.com/developers/guides/advanced/how-to-use-priority-fees) are the equivalent acceleration fee for Ethereum and Solana
...
* [L1 Blockchain](https://digitalsovereignty.herbertyang.xyz/p/decoding-the-crypto-ecosystem-ep01-blockchains)'s landscape is more or less settled. What is not settled, is how much your L1 bag is.
...
Pima offers very thought-provoking insights. It’s a great conversation that would help people understand why memecoin has become a global movement. I particularly like his analogy of memecoin launchpads to [L1 blockchains](https://digitalsovereignty.herbertyang.xyz/p/decoding-the-crypto-ecosystem-ep01-blockchains).
